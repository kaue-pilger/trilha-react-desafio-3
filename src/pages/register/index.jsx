...
import { Container, Title, Column, TitleRegister, SubtitleRegister, JaTenhoContaText, FazerLoginText, Row, Wrapper, TermosText } from './styles';
        ...
        <Container>
            ...
            <Column>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <Input placeholder="Nome completo" leftIcon={<MdSupervisorAccount/>} name="name"  control={control} />
                ...
                <Row>
                    <JaTenhoContaText>Esqueci minha senha</JaTenhoContaText>
